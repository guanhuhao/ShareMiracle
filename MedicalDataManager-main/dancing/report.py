...
def make_report_html(content: str) -> str:
    """
    撰写报告，输入参数为 markdown 字符串

    返回，用于 SMTP 传输的 HTML 文本
    """
    html = markdown.markdown(content, extensions=exts)
    return html_template.format(html, css_template)
