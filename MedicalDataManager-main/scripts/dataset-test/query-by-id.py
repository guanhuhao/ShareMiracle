...
config = yaml.load(open('../../config/DataSet.yml', 'r'), Loader=yaml.Loader)
...
url = f'http://{host}:{port}/{api}/query-by-id' 
...
try:
    with open('./data/test-dataset/query-by-id.json', 'r', encoding='utf-8') as file:
        data = json.load(file)
